...
In simple terms: The MPL-2.0 license implements a non-viral copyleft that only affects the licensed files, but not the project that include these files. MPL-2.0 licensed files can thus be deeply integrated even in comercial closed source projects. Further, MPL includes an explicit clause to make it compatible with GPL (>2.0) projects. 
